...
const ARTS: ArtKey[] = ["a", "b", "c", "d", "e", "f", "g", "h"];
const CATS = ["slots", "jackpots", "megaways", "bonus buy", "new"];
export const GAMES: Game[] = NAMES.map((title, i) => ({
  id: "g" + i, title, provider: P[(i * 7) % 3], art: ARTS[(i * 5 + Math.floor(i / 8)) % 8], category: CATS[i % 5],
...
export const LIVE = [
  { id: "l1", title: "Lightning Roulette", provider: "Aurum Live", art: "b" as ArtKey, players: "1,204" },
  { id: "l2", title: "Crazy Time", provider: "Nova Live", art: "e" as ArtKey, players: "3,871" },
