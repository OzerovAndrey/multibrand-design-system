  ...
  return (
    <div className="main container">
      ...
      <section className="stack section">
        ...
        <div className="grid grid--cards">{TOURNAMENTS.slice(0, 3).map((t) => <TournamentCard key={t.id} id={t.id} state={t.state} title={t.title} prize={t.prize} time={t.time} players={t.players} progress={t.progress} />)}</div>
